...
struct StatsRecursive {
    ...
    Entry<Spectrum> pixel2nd { "pixel.2nd" };

    Entry<Spectrum> liBsdf { "li.bsdf" };
    Entry<Spectrum> liNee { "li.nee" };
    Entry<Spectrum> misBsdf { "mis.bsdf" };
    Entry<Spectrum> misNee { "mis.nee" };
    Entry<Float> fraction { "fraction" };

    Entry<Spectrum> neeFirstMoment { "fm.nee" };
    Entry<Spectrum> neeSecondMoment { "sm.nee" };
    Entry<Spectrum> neeVariance { "var.nee" };
    Entry<Spectrum> bsdfFirstMoment { "fm.bsdf" };
    Entry<Spectrum> bsdfSecondMoment { "sm.bsdf" };
    Entry<Spectrum> bsdfVariance { "var.bsdf" };
    Entry<Spectrum> bestVariance { "var.best" };
    ...
    void reset() {
        ...
        neeFirstMoment.reset();
        neeSecondMoment.reset();
        neeVariance.reset();

        bsdfFirstMoment.reset();
        bsdfSecondMoment.reset();
        bsdfVariance.reset();
