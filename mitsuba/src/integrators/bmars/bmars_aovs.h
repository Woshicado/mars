#ifndef __M_BMARS_AOVS_H
#define __M_BMARS_AOVS_H
...
struct StatsRecursive {
    ...
    Entry<Spectrum>    albedo           { "px.albedo"    };
    Entry<Spectrum>    pixelEstimate    { "px.estimate"  };
    Entry<Float>       cost             { "px.cost"      };
    ...
    Stack<Float, 4>    splittingFactorL { "d.rrsL"          };

    Entry<Spectrum>    lrFactorS        { "e.lrFact.s"      };
    Entry<Spectrum>    lrFactorR        { "e.lrFact.r"      };
    Entry<Spectrum>    neeFactorS       { "e.neeFact.s"     };
    Entry<Spectrum>    neeFactorR       { "e.neeFact.r"     };
    Entry<Spectrum>    lpFactorS        { "e.lpFact.s"      };
    Entry<Spectrum>    lpFactorR        { "e.lpFact.r"      };

    Entry<Spectrum>    lrEstimate       { "f.lrEstimate"    };
    Entry<Spectrum>    neeEstimate      { "f.neeEstimate"   };
    Entry<Spectrum>    lpEstimate       { "f.lpEstimate"    };

    Stack<Spectrum, 4> neeEmitted       { "g.neeEmitted"    };
    Stack<Spectrum, 4> lpEmitted        { "g.lpEmitted"     };
    Stack<Spectrum, 4> lrEmitted        { "g.lrEmitted"     };
